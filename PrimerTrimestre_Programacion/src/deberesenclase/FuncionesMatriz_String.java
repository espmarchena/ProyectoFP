...
public class FuncionesMatriz_String {
	...
	public static void main(String[] args) {
		...
		for (int i=0; i<personas.length; i++) { //personas.length devuelve un 2 (las filas)
			...
			System.out.println(personas[i][0]); // pinta el nombre de todas las personas, porque estan en la fila i que va a ir recorriendo todas las filas y en la posicion 0 siempre
