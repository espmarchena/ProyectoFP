...
public class Ejercicio1 {
	...
	public static void main(String[] args) {
		// Crear una función que recibe una matriz y devuelve un array relleno con los
	...
	public static int[] PasarMatrizAArray(int[][] matriz) {
		...
		for (int i = 0; i < matriz.length; i++) {
			totalValores += matriz[i].length;       /*suma el número de columnas de la fila actual al acumulador 'totalValores'.
													Al final del bucle el acumulador valdrá el número total de elementos de la matriz*/
		}
