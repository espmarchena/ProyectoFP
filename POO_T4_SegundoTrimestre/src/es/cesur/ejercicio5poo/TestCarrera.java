...
public class TestCarrera {
	...
	public static void main(String[] args) {
		...
		System.out.println("El " + coche1.getFabricante() + " " + coche1.getModelo() + " se fabricó en el año " + coche1.getAñoFabricacion() + ". ¿Es de gasolina?: " + coche1.isGasolina());
		
		Coche coche2 = new Coche("Ford", "Focus", 2018, false);
		System.out.println("El " + coche2.getFabricante() + " " + coche2.getModelo() + " se fabricó en el año " + coche2.getAñoFabricacion() + ". ¿Es de gasolina?: " + coche2.isGasolina());
